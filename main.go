...
func main() {
	...
	includeIpv6 := flag.Bool("ipv6", true, "Process IPv6 data")
	includeAws := flag.Bool("aws", true, "Include AWS data")
	includeAzure := flag.Bool("azure", true, "Include Azure data")
	...
	includeLocation := flag.Bool("location", true, "Include location map")
	includeContinent := flag.Bool("continent", true, "Include continent map")
	includeCountry := flag.Bool("country", true, "Include country map")
	includeSubdivisions := flag.Bool("subdivisions", true, "Include subdivisions map")
	includeCity := flag.Bool("city", true, "Include city map")
	includeSpamhaus := flag.Bool("spamhaus", true, "Include spamhaus data")
